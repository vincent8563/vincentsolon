...
import { ExternalLink, Server, Network, Mail, Shield, Workflow, Zap, Bot, Cloud } from "lucide-react";
...
const ProjectCard = ({ project }: { project: any }) => (
  <div className="group rounded-2xl overflow-hidden border border-gray-200 dark:border-gray-700 hover:border-indigo-500 dark:hover:border-indigo-400 transition-all duration-300 shadow-md hover:shadow-xl h-full flex flex-col bg-white dark:bg-gray-800">
    <div className="h-52 relative overflow-hidden bg-gray-100 dark:bg-gray-900 flex-shrink-0">
      {project.image ? (
        <img
          src={project.image}
          alt={project.title}
    ...
    <div className="p-5 flex flex-col flex-1">
      ...
      <div className="flex flex-wrap gap-2">
        {project.technologies.map((tech: string) => (
          <span key={tech} className="px-2 py-1 rounded-md bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 text-xs font-medium">
            {tech}
          </span>
        ))}
      </div>
